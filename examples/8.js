  ...
  render: function() {
    return (
      React.createElement("div", {className: "box", style: {backgroundColor: this.props.bgcolor}}, 
        React.createElement("h3", {className: "mybox", style: this.props.myBoxStyle}, this.state.number)
      )
    )
  }
});
...
React.render(React.createElement(App, {exampleNumber: "8", subtitle: "CSS"}), document.body);
